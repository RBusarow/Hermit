  ...
  new.printWriter()
    .use { writer ->
      ...
      val dependencyMatchers = listOf(
        ...
        Libs.JUnit.vintage.toDependencyMatcher(),
        Libs.JUnit.runtime.toDependencyMatcher(),
        Libs.JUnit.params.toDependencyMatcher(),
        Libs.JUnit.api.toDependencyMatcher(),
        Libs.JUnit.core.toDependencyMatcher(),
